...
},
{
    ...
    loader:({params})=>fetch(`https://cine-vibe-express-server.vercel.app/api/allBlogs/${params._id}`)
  },
  {
    path:"/moviesDetails/:_id",
    element:<MovieDetails></MovieDetails>,
    loader:({params})=>fetch(`https://cine-vibe-express-server.vercel.app/api/allMovies/${params._id}`)
  },
  {
    path:"/seriesDetails/:_id",
    element:<SeriesDetails></SeriesDetails>,
    loader:({params})=>fetch(`https://cine-vibe-express-server.vercel.app/api/allSeries/${params._id}`)
  },
