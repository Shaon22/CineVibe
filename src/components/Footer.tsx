...
export default function Footer() {
  return (
    <footer className="relative w-full overflow-hidden shadow-2x">
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <nav className="flex justify-center mb-12">
            <ul className="flex flex-wrap justify-center gap-8 text-white">
              <li>
                <a href="/" className="hover:text-pink-200 transition-colors text-lg">
                  Home
                </a>
              </li>
              <li>
                <a href="/about" className="hover:text-pink-200 transition-colors text-lg">
                  About
                </a>
              </li>
              <li>
                <a href="/blogs" className="hover:text-pink-200 transition-colors text-lg">
                  Blogs
                </a>
              </li>
              <li>
                <a href="/pricing" className="hover:text-pink-200 transition-colors text-lg">
                  Pricing Plan
                </a>
              </li>
              <li>
                <a href="/contact" className="hover:text-pink-200 transition-colors text-lg">
                  Contact Us
                </a>
              </li>
            </ul>
