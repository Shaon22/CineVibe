...
const Live = () => {
  ...
  const handleMouseUp = useCallback(() => {
    ...
    setDragOffset(0)
  }, [isDragging, dragOffset, startIndex, maxIndex, itemsPerView])
              ...
              {videos.map((video) => (
                ...
                >
                  <div className="video-card">
                    <div className="relative aspect-[1/2] rounded-lg overflow-hidden mb-3">
                      {" "}
                      {/* Changed to aspect-[1/2] for even taller cards */}
                      <img
                      ...
                      />
                      {/* Live indicator */}
                      <div className="absolute top-2 left-2 bg-red-600 text-white text-xs px-2 py-1 rounded flex items-center font-bold gap-1 "><Radio/>LIVE
                        
                      </div>
                    </div>
                    <div className="text-xs text-gray-400 mb-2">{video.channel}</div>
                    <h3 className="font-medium mb-2 line-clamp-2 leading-tight">{video.title}</h3>
